sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("salesoreder/SalesOrder/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("salesoreder.SalesOrder.test.integration.arrangements.Arrangement", {
